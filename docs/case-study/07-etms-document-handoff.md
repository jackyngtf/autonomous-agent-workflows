...
A subsequent [static finding](../evidence/etms-deployment-review-2026-09-22.md#live-publication-limitation-found-after-the-shadow-run) identified a live-publisher parser that misses paths containing whitespace. It could skip upload checks while still reaching inbox cleanup after local swaps. The shadow result does not establish live readiness; the private guard passed nine offline test methods and was deployed on 23 September with verified backups. Configuration is now live; the first live Cowork run remains pending. The [dated follow-up](../evidence/etms-deployment-review-2026-09-22.md#guard-deployment-and-live-configuration-23-september-2026) records the new driver hash.
