...
| ETMS-CONTRACT | **Source inspection / design rule:** weekday 09:30 engine handoff, operator-controlled shadow/live modes and restricted file writes | Private `etms-doc-swap/SKILL.md`, lines 1–14 and 22–34 | [eTMS case](../case-study/07-etms-document-handoff.md). Entry instructions only; remote deployment, timezone, current mode, successful swaps and rollback unverified. No local engine, tests or swap reports found in the inspected material. |
